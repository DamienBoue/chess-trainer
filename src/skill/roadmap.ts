...
export const MODULES_BY_BRACKET: Record<SkillBracket['id'], RoadmapModule[]> = {
  ...
  club: [
    ...
    { id: 'club-pawn-structure',area: 'middlegame', title: 'Comprendre les structures de pions courantes', why: 'Le plan en milieu de jeu découle de la structure.', surface: 'library' },
    { id: 'club-isolated-pawn', area: 'middlegame', title: 'Pion isolé : forces et faiblesses', why: 'Une des structures les plus fréquentes — savoir l\'attaquer et la défendre.', surface: 'library' },
  ],
  tournament: [
    ...
    { id: 'tour-strategic-imb', area: 'middlegame', title: 'Déséquilibres stratégiques (Silman)', why: 'Cadre formel pour choisir un plan en milieu de jeu.', surface: 'library' },
  ...
  expert: [
    { id: 'exp-master-games',   area: 'middlegame', title: 'Étudier des parties modèles (Capablanca, Karpov)', why: 'L\'absorbtion de schémas positionnels passe par l\'imitation consciente.', surface: 'library' },
